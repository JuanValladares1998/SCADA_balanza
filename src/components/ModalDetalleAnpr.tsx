...
function ModalDetalleAnpr({ visible, detalle, cargando, error, onClose }: ModalDetalleAnprProps) {
  ...
  return (
    <Modal visible={visible} title={detalle ? `Detalle ANPR: ${detalle.plate}` : "Detalle ANPR"} onClose={onClose}>
      {cargando ? (
          ...
          {imageUrl ? (
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                ...
                {crop && imageSize ? (
                  <div className="flex h-[220px] items-center justify-center rounded-md border border-slate-200 bg-black">
                    <div
                  ...
                  <div className="flex h-[220px] items-center justify-center rounded-md border border-slate-200 bg-white text-sm text-slate-500">
...
export default ModalDetalleAnpr;
