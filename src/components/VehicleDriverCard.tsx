      ...
      <div className="flex gap-4">
        ...
        <div className="w-1/2 flex flex-col gap-3 justify-center">
          <div>
            ...
            <div className="scada-soft-box px-2 py-1 font-mono text-lg font-bold">ABC-123</div>
          </div>
          <div>
            <label className="text-xs scada-text-secondary font-semibold uppercase">Chofer</label>
            <div className="text-sm font-semibold scada-text-primary">Juan Perez</div>
          </div>
        </div>
      </div>
    </article>
